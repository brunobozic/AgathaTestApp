...
namespace Agathas.Storefront.Services
{
    public class AutoMapperBootStrapper
    {
        public static void ConfigureAutoMapper()
        {
            ...
            Mapper.CreateMap<Basket, BasketView>().ForMember(o => o.ShippingServiceDescription, o => o.Ignore());

            // Customer
            Mapper.CreateMap<Customer, CustomerView>();
            Mapper.CreateMap<DeliveryAddress, DeliveryAddressView>().ForMember(o => o.Name, o => o.Ignore());

            // Orders
            Mapper.CreateMap<Order, OrderView>();
            Mapper.CreateMap<OrderItem, OrderItemView>();
            Mapper.CreateMap<Address, DeliveryAddressView>().ForMember(o => o.Name, o => o.Ignore());
